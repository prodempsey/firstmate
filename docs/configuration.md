...
FM_SERVING_WORKTREE=     # optional serving worktree/git dir path used by fm-needs-firstmate-reconcile.sh to detect a landed tip already ancestor-of-serving-HEAD; absent skips that containment check
